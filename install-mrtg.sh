#!/bin/bash
#
# MRTG Professional Monitoring Suite - Enterprise Edition v2.1.5
...
readonly SCRIPT_VERSION="v2.1.5"
...
#!/bin/bash
# Rspamd Statistics Collector for MRTG v2.1.5
...
#!/bin/bash
# MRTG Runner - Generated by MRTG Professional Suite v2.1.5
