#!/bin/bash
#
# MRTG Professional Monitoring Suite - Enterprise Edition v2.2.1
...
#!/bin/bash
# Rspamd Statistics Collector for MRTG v2.2.1
...
#!/bin/bash
# MRTG Runner - Generated by MRTG Professional Suite v2.2.1
