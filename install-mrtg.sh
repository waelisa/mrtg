#!/bin/bash
#
# MRTG Professional Monitoring Suite - Enterprise Edition v2.1.1
...
#   - SNMPv3 support for enterprise security
...
#!/bin/bash
# Rspamd Statistics Collector for MRTG v2.1.1
...
#!/bin/bash
# MRTG Runner - Generated by MRTG Professional Suite v2.1.1
...
EOF
    ...
    echo ""
    # Removed recursive call - menu will loop in main()
}
